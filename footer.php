<footer class="bg-primarybg text-primaryText ">
    <div class="px-10 py-10 md:flex flex-wrap justify-center">
        <div class="mx-auto">
            <div class="mx-auto">
                <img src="./src/logopnp.png" alt="" class="w-[150px] opacity-20 hover:opacity-100 duration-150">
            </div>
        </div>
        <div class="mx-auto">
            <div>
        ...
        <div class="mx-auto">
            <h3> Major</h3>
            <ul>
                <li class="pt-5">Telecommunication Engineering</li>
            </ul>
        </div>
        <div class="mx-auto">
            <h3> Member of Team</h3>
            <ul>
                <li class="pt-5">Mr. Firdaus </li>
                <li>Mrs. Vera</li>
                <li>Sukma</li>
                <li>Falhan </li>
